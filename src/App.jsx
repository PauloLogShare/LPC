...
function App() {
  ...
  const abrirPricing = () => { 
    ...
    setVisao("pricing"); 
    document.getElementById("lpc-visoes")?.scrollIntoView({ behavior: "smooth" }); 
  };
    ...
    <div className={`lpc-app-shell ${menuRecolhido ? "sidebar-collapsed" : ""}`}>
      ...
      <div className="lpc-platform-body">
          ...
          <nav className="lpc-sidebar-nav">
            <button className={`lpc-sidebar-item ${menuAtivo === "importacao" ? "active" : ""}`} onClick={irParaImportacao}>
              <span className="lpc-sidebar-icon">⇧</span>{!menuRecolhido && <span className="lpc-sidebar-label">Importação</span>}
            </button>
            
            <button className={`lpc-sidebar-item ${["clientes", "painel"].includes(menuAtivo) ? "active" : ""}`} onClick={alternarIndicadores}>
              <span className="lpc-sidebar-icon">▦</span>{!menuRecolhido && <span className="lpc-sidebar-label">Indicadores</span>}
            ...
            {!menuRecolhido && indicadoresAbertos && (
              <div className="lpc-sidebar-submenu">
                <button className={`lpc-sidebar-subitem ${menuAtivo === "clientes" ? "active" : ""}`} onClick={abrirClientesPoc}>
                  <span className="lpc-subitem-icon">●</span><span>Clientes em POC</span>
                </button>
                <button className={`lpc-sidebar-subitem ${menuAtivo === "painel" ? "active" : ""}`} onClick={abrirPainelPoc}>
                  <span className="lpc-subitem-icon">▥</span><span>Painel de POC</span>
                </button>
              </div>
            )}

            {/* BOTÃO DO PRICING INTELLIGENCE */}
            <button className={`lpc-sidebar-item ${menuAtivo === "pricing" ? "active" : ""}`} onClick={() => { setMenuAtivo("pricing"); setVisao("pricing"); }}>
          ...
          {/* CHAMA A NOVA TELA DE PRICING */}
          {visao === "pricing" && <PricingIntelligence />}
        </main>
